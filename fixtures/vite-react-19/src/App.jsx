...
function App() {
  ...
  return (
    <>
      ...
      <div className="ticks"></div>
      <section id="about-reactive-axi">
        <h2>Reviewed with Reactive-Axi</h2>
        <p>
          This preview is live. Click any element on this page and tell your
          agent what to change — it hot-reloads right here, automatically.
        </p>
      </section>
    </>
  )
