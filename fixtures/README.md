...
Naming convention: `{framework}[-react-{majorVersion}]` — the version suffix is omitted only for "whatever's current," so every fixture's name states exactly what it's proving.
